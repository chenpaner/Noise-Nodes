...
class ShaderNodeWavy(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        line_thickness_socket = nt.interface.new_socket(
            name="Line Thickness", in_out='INPUT', socket_type='NodeSocketFloat')
        line_thickness_socket.default_value = 0.0
        ...
        hue_saturation_value = nt.nodes.new(
        ...
        # Value_001
        math_009.inputs[1].default_value = 0.0

        # Node Math.010
        math_010 = nt.nodes.new("ShaderNodeMath")
        math_010.name = "Math.010"
        math_010.operation = 'ABSOLUTE'
        ...
        group_input.location = (-941.1726684570312, -210.3057403564453)
        ...
        hue_saturation_value.location = (-29.928512573242188,
                                         298.6106262207031)
        hue_saturation_value_001.location = (-26.235519409179688,
                                             123.8736572265625)
        math_009.location = (-857.5619506835938, 298.9051818847656)
        math_010.location = (-1035.8792724609375, 251.93914794921875)
        texture_coordinate_001.location = (-1212.4619140625, 309.8512268066406)
        mix_006.location = (-639.8927612304688, 315.3171691894531)
        ...
        nt.links.new(
            math_008.outputs[0], musgrave_texture.inputs[4])
        # math_006.Value -> math_007.Value
        nt.links.new(math_006.outputs[0], math_007.inputs[0])
        # bright_contrast.Color -> mix.Factor
        nt.links.new(
            bright_contrast.outputs[0], mix.inputs[0])
        # hue_saturation_value.Color -> mix.A
        nt.links.new(
            hue_saturation_value.outputs[0], mix.inputs[6])
        # hue_saturation_value_001.Color -> mix.B
        nt.links.new(
            hue_saturation_value_001.outputs[0], mix.inputs[7])
        # math_005.Value -> bright_contrast.Color
        nt.links.new(
            math_005.outputs[0], bright_contrast.inputs[0])
        # group_input.Line Thickness -> bright_contrast.Contrast
        nt.links.new(
            group_input.outputs[4], bright_contrast.inputs[2])
        ...
        # math_009.Value -> mix_006.Factor
        nt.links.new(math_009.outputs[0], mix_006.inputs[0])
        # texture_coordinate_001.Generated -> mix_006.A
        nt.links.new(
            texture_coordinate_001.outputs[0], mix_006.inputs[6])
        # math_010.Value -> math_009.Value
        nt.links.new(math_010.outputs[0], math_009.inputs[0])
        ...
        # group_input.Vector -> math_010.Value
        nt.links.new(
            group_input.outputs[0], math_010.inputs[0])
