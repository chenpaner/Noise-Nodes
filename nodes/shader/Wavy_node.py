...
class ShaderNodeWavy(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        mask_socket.min_value = -3.4028234663852886e38
        mask_socket.max_value = 3.4028234663852886e38
        ...
        linethickness_socket = nt.interface.new_socket(
            name="Line Thickness", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        linethickness_socket.default_value = 0.0
        linethickness_socket.min_value = -3.4028234663852886e38
        linethickness_socket.max_value = 3.4028234663852886e38
