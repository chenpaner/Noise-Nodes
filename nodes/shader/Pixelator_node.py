...
class ShaderNodePixelator(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        # Socket Division
        division_socket = nt.interface.new_socket(
            name="Division", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        division_socket.subtype = "NONE"
        division_socket.default_value = 10.0
        division_socket.min_value = 0.0
        division_socket.max_value = 3.4028234663852886e38
        ...
        offset_socket.min_value = -3.4028234663852886e38
        offset_socket.max_value = 3.4028234663852886e38
