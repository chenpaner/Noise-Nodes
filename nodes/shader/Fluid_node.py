...
class ShaderNodeFluid(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        # Socket Scale Ratio
        scale_ratio_socket = nt.interface.new_socket(
            name="Scale Ratio", in_out="INPUT", socket_type="NodeSocketFloat"
        )
        ...
        # Socket Detail 1
        detail_1_socket = nt.interface.new_socket(
        ...
        # Socket Detail 2
        detail_2_socket = nt.interface.new_socket(
