...
class ShaderNodeVoxel(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        voxel_position_socket = nt.interface.new_socket(
            name="Voxel Position", in_out="OUTPUT", socket_type="NodeSocketVector"
        )
        voxel_position_socket.default_value = (0.0, 0.0, 0.0)
        voxel_position_socket.min_value = -3.4028234663852886e38
        voxel_position_socket.max_value = 3.4028234663852886e38
        voxel_position_socket.subtype = "NONE"
        voxel_position_socket.attribute_domain = "POINT"

        # Socket Voxel Vector
        voxel_vector_socket = nt.interface.new_socket(
            name="Voxel Vector", in_out="OUTPUT", socket_type="NodeSocketVector"
        )
        voxel_vector_socket.default_value = (0.0, 0.0, 0.0)
        voxel_vector_socket.min_value = -3.4028234663852886e38
        voxel_vector_socket.max_value = 3.4028234663852886e38
