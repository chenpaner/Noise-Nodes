...
class ShaderNodeScratches(ShaderNode):
    ...
    def createNodetree(self, name):
        ...
        # Socket Cells
        cells_socket = nt.interface.new_socket(
            name="Cells", in_out="OUTPUT", socket_type="NodeSocketColor"
        )
        cells_socket.default_value = (0.0, 0.0, 0.0, 1.0)
        cells_socket.attribute_domain = "POINT"

        # Socket Falloff
        falloff_socket = nt.interface.new_socket(
        ...
        # Socket Spread
        spread_socket = nt.interface.new_socket(
